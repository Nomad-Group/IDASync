...
void idaapi load_file(linput_t *li, ushort /*neflags*/, const char * /*ffn*/)
{
  ...
  inf.start_ip = start_address & 0xffff;
  ...
  // ------- Undefined vectors
  create_word(xlat(0xffe0), 2);
  create_word(xlat(0xffe2), 2);
  create_word(xlat(0xfff0), 2);
  create_word(xlat(0xfff2), 2);
  create_word(xlat(0xfff6), 2);
