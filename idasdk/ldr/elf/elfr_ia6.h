...
enum elf_RTYPE_ia64
{
  ...
  R_IA64_LTV32MSB        = 0x70, /* symbol + addend, data4 MSB */
  R_IA64_LTV32LSB        = 0x71, /* symbol + addend, data4 LSB */
  R_IA64_LTV64MSB        = 0x72, /* symbol + addend, data8 MSB */
  R_IA64_LTV64LSB        = 0x73, /* symbol + addend, data8 LSB */
...
#define ELF_RPL_IA64_DEFAULT  (ELF_RPL_PLP | ELF_RPL_GL | ELF_RPL_UNL | ELF_BS_DBG)
