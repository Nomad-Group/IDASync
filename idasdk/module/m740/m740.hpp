...
inline bool is_displ_indx(void) { return (cmd.auxpref & INSN_DISPL_INDX) != 0; }
inline bool is_displ_indy(void) { return (cmd.auxpref & INSN_DISPL_INDY) != 0; }
inline bool is_displ_zpx(void)  { return (cmd.auxpref & INSN_DISPL_ZPX) != 0; }
inline bool is_displ_zpy(void)  { return (cmd.auxpref & INSN_DISPL_ZPY) != 0; }
inline bool is_displ_absx(void) { return (cmd.auxpref & INSN_DISPL_ABSX) != 0; }
inline bool is_displ_absy(void) { return (cmd.auxpref & INSN_DISPL_ABSY) != 0; }
...
inline bool is_addr_sp(op_t &op) { return (op.specflag1 & OP_ADDR_SP) != 0; }
inline bool is_addr_ind(op_t &op) { return (op.specflag1 & OP_ADDR_IND) != 0; }
inline bool is_addr_read(op_t &op) { return (op.specflag1 & OP_ADDR_R) != 0; }
inline bool is_addr_write(op_t &op) { return (op.specflag1 & OP_ADDR_W) != 0; }
