...
//----------------------------------------------------------------------
static void attach_bit_comment(const insn_t &insn, int addr, int bit)
{
...
//----------------------------------------------------------------------
static void attach_name_comment(const insn_t &insn, op_t &x, ea_t v)
{
  qstring qbuf;
...
static void handle_operand(insn_t &insn, op_t &x, bool loading)
{
...
//----------------------------------------------------------------------
bool idaapi xa_is_switch(switch_info_t *si, const insn_t &_insn)
{
