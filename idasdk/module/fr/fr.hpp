...
inline bool op_displ_imm_r14(op_t &op) { return (op.specflag1 & OP_DISPL_IMM_R14) != 0; }
inline bool op_displ_imm_r15(op_t &op) { return (op.specflag1 & OP_DISPL_IMM_R15) != 0; }
