...
static const opcode *get_opcode(int word)
{
...
bool ana_special(insn_t &insn, int word, int *s)
{
  bool special = false;
...
//----------------------------------------------------------------------------
static int parse_fp_insn(insn_t &insn, int word)
{
