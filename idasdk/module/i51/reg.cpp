...
#define APPLY_IO_PORT i51_apply_io_port
//lint -esym(528,i51_apply_io_port) not referenced
static void i51_apply_io_port(ea_t ea, const char *name, const char *cmt)
{
  if ( ea >= 0x80 && ea < 0x100 )
  {
