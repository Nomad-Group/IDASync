...
{
  return set_name(ea, name, flags|SN_FORCE);
}
...
enum ucdr_kind_t
{
  ...
  URK_MangleChars = 0x2,
  URK_StrlitChars = 0x4,
  URK_TypeNameChars = 0x8,
};

enum nametype_t
{
  // identifier (e.g., function name)
  VNT_IDENT = URK_NameChars|URK_MangleChars,
  // type name (can contain '<', '>', ...)
  VNT_TYPE = URK_TypeNameChars,
  // UDT (structure, union, enum) member
  VNT_UDTMEM = URK_NameChars,
  // string literal
  VNT_STRLIT = URK_StrlitChars,
