        ...
        This SDK should be used with IDA kernel version 7.0
...
-------------------
  ...
  MS Windows:
    - Visual C++ 2015 (14.0) or later
    - Visual C++ 2008 (for debugger servers)
...
---------
  ...
  To build the debugger servers, the 'pro' library and 'dumb' object are
  needed. These files are provided for the following architectures:
  ...
  NOTE: To build the debug servers for MS Windows targets, Visual Studio 2008
        must be used, along with Microsoft Windows SDK v7.1A.
